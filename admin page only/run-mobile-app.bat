@echo off
title Sarvottam Institutes - Mobile App Launcher (iOS / Android / Web)
echo ===================================================================
echo   Starting Sarvottam Institutes Mobile App from Admin Directory
...
start "" "%~dp0..\open-app.html?ip=%LAN_IP%"
echo.
